                        ...
                        children: [
                          InkWell(
                            onTap: () async {
                              ...
                              if (contacts[i]['tanggal'].runtimeType != Null) {
                              ...
                              if (contacts[i]['color'].runtimeType != Null) {
                                currentColor = Color(int.parse(contacts[i]
                                        ['color']
                                    .toString()
                                    .split('(')[1]
                                    .split(')')[0]));
                              ...
                              if (contacts[i]['file'].runtimeType != Null &&
                                  contacts[i]['file'] != "") {
                                _fileName = contacts[i]['file'].split('/')[6];
                                _filePath = contacts[i]['file'];
                              } else {
                                _fileName = null;
                                _filePath = "";
                              }
