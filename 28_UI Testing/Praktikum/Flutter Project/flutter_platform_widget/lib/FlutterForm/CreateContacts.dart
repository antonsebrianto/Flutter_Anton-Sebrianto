      ...
      child: Scaffold(
        ...
        body: ListView(
          children: <Widget>[
            ...
            Container(
              key: const Key("_formColorPicker"),
              width: double.infinity,
              padding: const EdgeInsets.only(left: 16),
              child: const Text(
                'Color',
