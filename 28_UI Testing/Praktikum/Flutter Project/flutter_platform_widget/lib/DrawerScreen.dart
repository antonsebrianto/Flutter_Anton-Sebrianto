    ...
    return Drawer(
      ...
      children: <Widget>[
        ...
        DrawerListTile(
          title: "Post Contact",
          onTilePressed: () {
            Navigator.pushNamed(context, '/post_contact');
          },
        ),
        DrawerListTile(
          title: "Contact API",
          onTilePressed: () {
            Navigator.pushNamed(context, '/contact_api');
          },
        ),
        DrawerListTile(
          title: "Put Request",
          onTilePressed: () {
            Navigator.pushNamed(context, '/put_request');
          },
        ),
        DrawerListTile(
          title: "Image DiceBear",
          onTilePressed: () {
            Navigator.pushNamed(context, '/image_dicebear');
          },
        ),
        DrawerListTile(
          title: "DiceBear",
