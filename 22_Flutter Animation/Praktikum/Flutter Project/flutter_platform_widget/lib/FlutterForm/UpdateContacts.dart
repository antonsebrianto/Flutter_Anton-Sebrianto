...
class UpdateContacts extends StatefulWidget {
  const UpdateContacts({Key? key}) : super(key: key);
...
class _UpdateContactsState extends State<UpdateContacts> {
  ...
  late TextEditingController nomorController = TextEditingController();
  ...
  void initState() {
    super.initState();
    // formContacts(ModalRoute.of(context)!.settings.arguments as int);
    // namaController =
...
//fungsi ubah contacts
  ...
  void formContacts(int id) async {
    ...
    // final dataContacts = contacts.firstWhere((element) =>
  ...
  Widget build(BuildContext context) {
    // selectedId = ModalRoute.of(context)!.settings.arguments as String;
    final Map<String, dynamic> data =
        ModalRoute.of(context)!.settings.arguments as Map<String, dynamic>;
    selectedId = data['id'].toString();

    namaController.text = data['nama'];
    nomorController.text = data['no_telp'];
    _selectedDate = DateTime.parse(data['tanggal']);
    currentColor =
        Color(int.parse(data['color'].toString().split('(')[1].split(')')[0]));
            ...
            Container(
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () async {
                    await ubahContacts(int.parse(selectedId));
